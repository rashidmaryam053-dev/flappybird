...
template <> constexpr inline auto PillarItem::qt_create_metaobjectdata<qt_meta_tag_ZN10PillarItemE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PillarItem, qt_meta_tag_ZN10PillarItemE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PillarItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10PillarItemE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10PillarItemE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10PillarItemE_t>.metaTypes,
    nullptr
} };
...
void *PillarItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10PillarItemE_t>.strings))
